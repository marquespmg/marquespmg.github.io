import { products } from './produtos'; // Ou importe seu array de produtos

// Função para gerar URL amigável (igual à que usamos)
...
function generateSiteMap(products) {
  const baseUrl = 'https://www.marquesvendaspmg.shop';
  const currentDate = new Date().toISOString().split('T')[0];

  return `<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <!-- Páginas fixas (mantenha as que você já tem) -->
  <url>
    <loc>https://www.marquesvendaspmg.shop/</loc>
  ...
  <url>
    <loc>https://www.marquesvendaspmg.shop/ofertas</loc>
    <lastmod>2024-12-19</lastmod>
  ...
  <url>
    <loc>https://www.marquesvendaspmg.shop/produtos</loc>
  ...
  <url>
    <loc>https://www.marquesvendaspmg.shop/indicacoes</loc>
    <lastmod>2024-12-19</lastmod>
  ...
  <url>
    <loc>https://www.marquesvendaspmg.shop/quem-somos</loc>
    <lastmod>2024-12-19</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.7</priority>
  </url>
  ...
  <url>
    <loc>https://www.marquesvendaspmg.shop/politica-de-privacidade</loc>
    <lastmod>2024-12-19</lastmod>
  ...
  <url>
    <loc>https://www.marquesvendaspmg.shop/termos</loc>
    <lastmod>2024-12-19</lastmod>
    <changefreq>yearly</changefreq>
    <priority>0.3</priority>
  </url>

  <!-- PRODUTOS DINÂMICOS (2004 produtos) -->
  ${products.map(product => `
  <url>
    <loc>${baseUrl}/produto/${product.id}-${generateSlug(product.name)}</loc>
    <lastmod>${currentDate}</lastmod>
    <changefreq>weekly</changefreq>
    <priority>${product.price > 0 ? '0.7' : '0.5'}</priority>
  </url>`).join('')}
</urlset>`;
}

export async function getServerSideProps({ res }) {
  // Seus produtos - substitua pela sua fonte de dados real
const products = [
