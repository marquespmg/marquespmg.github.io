...
const products = [
  ...
  { id: 598, name: 'PATINHO BOVINO CONGELADO ISCAS ALFAMA 2,5 KILO', category: 'Derivados de Bovino', price: 72.22, image: 'https://i.imgur.com/YUeixUV.png' },
  ...
  { id: 978, name: 'CALABRESA AURORA 5 KILO', category: 'Derivados de Suíno', price: 98.74, image: 'https://i.imgur.com/eu9D48E.png' },
  ...
  { id: 984, name: 'CALABRESA FATIADA RESFRIADA MISTER BEEF 1 KILO', category: 'Derivados de Suíno', price: 22.66, image: 'https://i.imgur.com/PM0b7zw.png' },
  { id: 985, name: 'CALABRESA FRICASA 2.5 KILO', category: 'Derivados de Suíno', price: 46.4, image: 'https://i.imgur.com/MOaWZUs.png' },
  { id: 986, name: 'CALABRESA FRIMESA 2.5 KILO', category: 'Derivados de Suíno', price: 48.73, image: 'https://i.imgur.com/QDdW7S7.png' },
  { id: 987, name: 'CALABRESA LACTOFRIOS 2 KILO', category: 'Derivados de Suíno', price: 37, image: 'https://i.imgur.com/xEvOsZH.png' },
  ...
  { id: 997, name: 'CALABRESA RETA PRIETO 2.5 KILO', category: 'Derivados de Suíno', price: 50.05, image: 'https://i.imgur.com/BVboaTK.png' },
  { id: 998, name: 'CALABRESA RETA SADIA 2.5 KILO', category: 'Derivados de Suíno', price: 55.8, image: 'https://i.imgur.com/RAAgvaC.png' },
  { id: 999, name: 'CALABRESA RETA SEARA 2.5 KILO', category: 'Derivados de Suíno', price: 52.69, image: 'https://i.imgur.com/NRcrQmb.png' },
  { id: 1000, name: 'CALABRESA SADIA 2.5 KILO', category: 'Derivados de Suíno', price: 55.68, image: 'https://i.imgur.com/bCKr7WO.png' },
  { id: 1001, name: 'CALABRESA SEARA 2.5 KILO', category: 'Derivados de Suíno', price: 52.96, image: 'https://i.imgur.com/XbAsHnn.png' },
  { id: 1002, name: 'PRODUTO EM FALTA', category: 'Derivados de Suíno', price: 0, image: 'https://i.imgur.com/BVqXpF4.png' },
  { id: 1003, name: 'COPA FATIADA AURORA 100 G PCT', category: 'Derivados de Suíno', price: 11.42, image: 'https://i.imgur.com/56PAqpp.png' },
  ...
  { id: 1009, name: 'LINGUIÇA SUÍNA CONGELADA CHURRASCO PÉROLA 5 KILO PCT', category: 'Derivados de Suíno', price: 72.05, image: 'https://i.imgur.com/w8Lqpqk.png' },
  ...
  { id: 1014, name: 'LINGUIÇA SUÍNA CONGELADA COM PROVOLONE SABOR DE BRAGANÇA 500 G PCT', category: 'Derivados de Suíno', price: 19.24, image: 'https://i.imgur.com/CSetcvU.png' },
  { id: 1015, name: 'LINGUIÇA SUÍNA CONGELADA CUIABANA COM QUEIJO SABOR DE BRAGANÇA 500 G PCT', category: 'Derivados de Suíno', price: 113.03, image: 'https://i.imgur.com/MtZqkVB.png' },
  { id: 1016, name: 'LINGUIÇA TOSCANA CONGELADA AURORA 5 KILO PCT', category: 'Derivados de Suíno', price: 128.23, image: 'https://i.imgur.com/8oGhvPL.png' },
  { id: 1017, name: 'LINGUIÇA TOSCANA CONGELADA NA BRASA PERDIGÃO 5 KILO PCT', category: 'Derivados de Suíno', price: 111.72, image: 'https://i.imgur.com/V1hvFeO.png' },
  { id: 1018, name: 'LINGUIÇA TOSCANA CONGELADA SADIA 5 KILO PCT', category: 'Derivados de Suíno', price: 95.16, image: 'https://i.imgur.com/LLYBv4e.png' },
  { id: 1019, name: 'LINGUIÇA TOSCANA CONGELADA SEARA 5 KILO PCT', category: 'Derivados de Suíno', price: 40.19, image: 'https://i.imgur.com/XhfxJIY.png' },
  { id: 1020, name: 'LOMBO CANADENSE AURORA 0.750G KG', category: 'Derivados de Suíno', price: 42.99, image: 'https://i.imgur.com/vwGyXk8.png' },
  { id: 1021, name: 'LOMBO CANADENSE CERATTI 1 KG', category: 'Derivados de Suíno', price: 26.97, image: 'https://i.imgur.com/hjVHusw.png' },
  { id: 1022, name: 'LOMBO CANADENSE DELI GOURMET 0.750G KG', category: 'Derivados de Suíno', price: 33.83, image: 'https://i.imgur.com/1uMkkwN.png' },
  { id: 1023, name: 'LOMBO CANADENSE LACTOFRIOS  1 KG', category: 'Derivados de Suíno', price: 36.07, image: 'https://i.imgur.com/lMIZ6hJ.png' },
  { id: 1024, name: 'LOMBO CANADENSE NOBRE  1 KG', category: 'Derivados de Suíno', price: 43.03, image: 'https://i.imgur.com/wrEkM1z.png' },
  { id: 1025, name: 'LOMBO CANADENSE SEARA GOURMET  1 KG', category: 'Derivados de Suíno', price: 26.48, image: 'https://i.imgur.com/fF5P9hU.png' },
  { id: 1026, name: 'LOMBO SUÍNO CONGELADO TEMPERADO PAMPLONA  1 KG', category: 'Derivados de Suíno', price: 248.63, image: 'https://i.imgur.com/bmVWPtF.png' },
  { id: 1027, name: 'LOMBO SUÍNO SALGADO PAMPLONA 10 KILO PCT', category: 'Derivados de Suíno', price: 143.44, image: 'https://i.imgur.com/OH85IXP.png' },
  { id: 1028, name: 'LOMBO SUÍNO SALGADO REFFINATO 5 KILO PCT', category: 'Derivados de Suíno', price: 14.65, image: 'https://i.imgur.com/0aNB7Y9.png' },
  { id: 1029, name: 'MORTADELA DEFUMADA GOURMET SEARA 5 KG', category: 'Derivados de Suíno', price: 22.22, image: 'https://i.imgur.com/u8EyZmM.png' },
  { id: 1030, name: 'MORTADELA DEFUMADA OURO PERDIGÃO 4 KG', category: 'Derivados de Suíno', price: 9.57, image: 'https://i.imgur.com/RLLALYh.png' },
  { id: 1031, name: 'MORTADELA REZENDE 5 KG', category: 'Derivados de Suíno', price: 10.51, image: 'https://i.imgur.com/G2TEWPo.png' },
  { id: 1032, name: 'MORTADELA TRADICIONAL AURORA 5 KG', category: 'Derivados de Suíno', price: 42.2, image: 'https://i.imgur.com/ZRF2A9s.png' },
  { id: 1033, name: 'MORTADELA TRADICIONAL BOLOGNA CERATTI 6 KG', category: 'Derivados de Suíno', price: 12.28, image: 'https://i.imgur.com/rHo7GaU.png' },
  { id: 1034, name: 'MORTADELA TRADICIONAL MARBA 5 KG', category: 'Derivados de Suíno', price: 87.98, image: 'https://i.imgur.com/MArz8B2.png' },
  { id: 1035, name: 'ORELHA SUÍNA SALGADA COM MÁSCARA FRIELLA 10 KILO PCT', category: 'Derivados de Suíno', price: 52.92, image: 'https://i.imgur.com/YfvYp5i.png' },
  { id: 1036, name: 'ORELHA SUÍNA SALGADA COM MÁSCARA REFFINATO 5 KILO PCT', category: 'Derivados de Suíno', price: 59.16, image: 'https://i.imgur.com/6JdXYmp.png' },
  { id: 1037, name: 'PAIO SUÍNO PAMPLONA 2.5 KILO PCT', category: 'Derivados de Suíno', price: 64.03, image: 'https://i.imgur.com/ZEH5u4n.png' },
  { id: 1038, name: 'PAIO SUÍNO SEARA 2.5 KILO PCT', category: 'Derivados de Suíno', price: 28.19, image: 'https://i.imgur.com/1IXAs5S.png' },
  { id: 1039, name: 'PANCETA SUÍNA CONGELADA TEMPERADA APERITIVO FRIMESA 1 KILO PCT', category: 'Derivados de Suíno', price: 28.89, image: 'https://i.imgur.com/RMeK8Qb.png' },
  { id: 1040, name: 'PANCETA SUÍNA CONGELADA TEMPERADA PAMPLONA 1 KG', category: 'Derivados de Suíno', price: 140.25, image: 'https://i.imgur.com/Z2kh7Gx.png' },
  { id: 1041, name: 'PARMA PRESUNTO CRU DESOSSADO ITALIANO PANINI 1 KG', category: 'Derivados de Suíno', price: 23.86, image: 'https://i.imgur.com/aIBnWlB.png' },
  { id: 1042, name: 'PARMA PRESUNTO CRU FATIADO ITALIANO CERATTI 100 G PCT', category: 'Derivados de Suíno', price: 18.31, image: 'https://i.imgur.com/JyY4msg.png' },
  { id: 1043, name: 'PARMA PRESUNTO CRU FATIADO ITALIANO DOR 80 G PCT', category: 'Derivados de Suíno', price: 66.68, image: 'https://i.imgur.com/dO6JEP9.png' },
  { id: 1044, name: 'PARMA PRESUNTO CRU FATIADO ITALIANO VITO BALDUCCI 500 G PCT', category: 'Derivados de Suíno', price: 29.63, image: 'https://i.imgur.com/fdGvni0.png' },
  { id: 1045, name: 'PARMA PRESUNTO CRU FATIADO NACIONAL SADIA 100 G PCT', category: 'Derivados de Suíno', price: 87.98, image: 'https://i.imgur.com/Zo9XzYg.png' },
  { id: 1046, name: 'PÉ SUÍNO SALGADO FRIELLA 10 KILO PCT', category: 'Derivados de Suíno', price: 47.82, image: 'https://i.imgur.com/8uLeMsN.png' },
  { id: 1047, name: 'PÉ SUÍNO SALGADO REFFINATO 5 KILO PCT', category: 'Derivados de Suíno', price: 66.5, image: 'https://i.imgur.com/Y9iLa7W.png' },
  { id: 1048, name: 'PEPPERONI FATIADO CERATTI 1 KILO PCT', category: 'Derivados de Suíno', price: 80.44, image: 'https://i.imgur.com/vWBhmIJ.png' },
  { id: 1049, name: 'PEPPERONI FATIADO FRIMESA 1 KILO PCT', category: 'Derivados de Suíno', price: 98.23, image: 'https://i.imgur.com/6Qoov6W.png' },
  { id: 1050, name: 'PEPPERONI FATIADO SADIA 1 KILO PCT', category: 'Derivados de Suíno', price: 10.42, image: 'https://i.imgur.com/QhrOKDZ.png' },
  { id: 1051, name: 'PEPPERONI FATIADO SEARA GOURMET 100 G PCT', category: 'Derivados de Suíno', price: 38.32, image: 'https://i.imgur.com/d6AmPEC.png' },
  { id: 1052, name: 'PERNIL SUÍNO CONGELADO DESFIADO ALFAMA 1 KILO PCT', category: 'Derivados de Suíno', price: 22.54, image: 'https://i.imgur.com/cFrpBzR.png' },
  { id: 1053, name: 'PERNIL SUÍNO CONGELADO SEM OSSO E SEM COURO FRIVATTI / FRIELLA 12 KG', category: 'Derivados de Suíno', price: 24.07, image: 'https://i.imgur.com/HFRNemS.png' },
  { id: 1054, name: 'PERNIL SUÍNO CONGELADO SEM OSSO TEMPERADO PAMPLONA 1 KG', category: 'Derivados de Suíno', price: 117.94, image: 'https://i.imgur.com/kDcuuUp.png' },
  { id: 1055, name: 'PERNIL SUÍNO SALGADO REFFINATO 5 KILO PCT', category: 'Derivados de Suíno', price: 29.49, image: 'https://i.imgur.com/DyBYdin.png' },
  { id: 1056, name: 'PICANHA SUÍNA CONGELADA TEMPERADA PAMPLONA 1 KG', category: 'Derivados de Suíno', price: 25.76, image: 'https://i.imgur.com/77sLmei.png' },
  { id: 1057, name: 'PORCO A PASSARINHO CONGELADO TEMPERADO FRIMESA 1 KILO PCT', category: 'Derivados de Suíno', price: 86.61, image: 'https://i.imgur.com/Xgf0bHh.png' },
  { id: 1058, name: 'PRESUNTO AURORA 3.5 KILO PÇ', category: 'Derivados de Suíno', price: 68.75, image: 'https://i.imgur.com/OrkMpUi.png' },
  { id: 1059, name: 'PRESUNTO DÁLIA 3.3 KILO PÇ', category: 'Derivados de Suíno', price: 7.65, image: 'https://i.imgur.com/XOYlXlu.png' },
  { id: 1060, name: 'PRESUNTO FATIADO PEQUENO SEARA 180 G PCT', category: 'Derivados de Suíno', price: 90.44, image: 'https://i.imgur.com/nXo9oNK.png' },
  { id: 1061, name: 'PRESUNTO PERDIGÃO 3.4 KILO PÇ', category: 'Derivados de Suíno', price: 72.49, image: 'https://i.imgur.com/unA51c5.png' },
  { id: 1062, name: 'PRESUNTO PRIETO 3.35 KILO PÇ', category: 'Derivados de Suíno', price: 73.94, image: 'https://i.imgur.com/9Hhipgd.png' },
  { id: 1063, name: 'PRESUNTO REZENDE 3.4 KILO PÇ', category: 'Derivados de Suíno', price: 104.65, image: 'https://i.imgur.com/xwIv7bR.png' },
  { id: 1064, name: 'PRESUNTO SADIA 3.45 KILO PÇ', category: 'Derivados de Suíno', price: 79.65, image: 'https://i.imgur.com/jYdJvz5.png' },
  { id: 1065, name: 'PRESUNTO SEARA 3.5 KILO PÇ', category: 'Derivados de Suíno', price: 98.82, image: 'https://i.imgur.com/EdruuYG.png' },
  { id: 1066, name: 'RABO SUÍNO SALGADO COM SUAN REFFINATO 5 KILO PCT', category: 'Derivados de Suíno', price: 165.75, image: 'https://i.imgur.com/NWlE5JO.png' },
  { id: 1067, name: 'RABO SUÍNO SALGADO SEM SUAN FRIELLA 10 KILO PCT', category: 'Derivados de Suíno', price: 210.76, image: 'https://i.imgur.com/ao6sOgf.png' },
  { id: 1068, name: 'ROSBEEF CERATTI 3 KILO PÇ', category: 'Derivados de Suíno', price: 211.38, image: 'https://i.imgur.com/j2rSn55.png' },
  { id: 1069, name: 'SALAME HAMBURGUÊS FATIADO DEFUMADO CERATTI 100 G PCT', category: 'Derivados de Suíno', price: 72.26, image: 'https://i.imgur.com/XyB5EJB.png' },
  { id: 1070, name: 'SALAME ITALIANO DEFUMADO AURORA 0.600 G KG', category: 'Derivados de Suíno', price: 75.06, image: 'https://i.imgur.com/QL6wEmj.png' },
  { id: 1071, name: 'SALAME ITALIANO DEFUMADO CERATTI 0.600 G KG', category: 'Derivados de Suíno', price: 11.38, image: 'https://i.imgur.com/B9Ye3ST.png' },
  { id: 1072, name: 'SALAME ITALIANO FATIADO DEFUMADO CERATTI 100 G PCT', category: 'Derivados de Suíno', price: 84.9, image: 'https://i.imgur.com/qHewMon.png' },
  { id: 1073, name: 'SALAME ITALIANO SADIA 0.600 G KG', category: 'Derivados de Suíno', price: 78.68, image: 'https://i.imgur.com/Dyk45At.png' },
  { id: 1074, name: 'SALAME ITALIANO SEARA GOURMET 0.675 G KG', category: 'Derivados de Suíno', price: 33.01, image: 'https://i.imgur.com/6Hcd24K.png' },
  { id: 1075, name: 'SALSICHA CONGELADA HOT DOG AURORA 3 KILO PCT', category: 'Derivados de Suíno', price: 24.89, image: 'https://i.imgur.com/un3fqwO.png' },
  { id: 1076, name: 'SALSICHA CONGELADA HOT DOG ESTRELA 3 KILO PCT', category: 'Derivados de Suíno', price: 65.43, image: 'https://i.imgur.com/nVKoynf.png' },
  { id: 1077, name: 'SALSICHA CONGELADA HOT DOG PERDIGÃO 5 KILO PCT', category: 'Derivados de Suíno', price: 56.89, image: 'https://i.imgur.com/98Grz7V.png' },
  { id: 1078, name: 'SALSICHA CONGELADA HOT DOG SADIA 3 KILO PCT', category: 'Derivados de Suíno', price: 37.32, image: 'https://i.imgur.com/l2pm4Rf.png' },
  { id: 1079, name: 'SALSICHA CONGELADA HOT DOG SEARA 5 KILO PCT', category: 'Derivados de Suíno', price: 49.45, image: 'https://i.imgur.com/N5HcIe0.png' },
  { id: 1080, name: 'TORRESMO PRÉ FRITO CHAPARRAL 500 G PCT', category: 'Derivados de Suíno', price: 17.37, image: 'https://i.imgur.com/C4N23ob.png' },
  ...
  { id: 1314, name: 'MARGARINA COM SAL 50 % AMÉLIA (BD 14 KILO)', category: 'Derivados de Vegetal', price: 115.70, image: 'https://i.imgur.com/L7eZnTu.png' },
  ...
  { id: 1725, name: 'FARINHA DE TRIGO PASTEL DONA BENTA 5 KILO (FDO 25 KILO)', category: 'Farináceos', price: 114.80, image: 'https://i.imgur.com/QKn1Qcq.png' },
  ...
  { id: 1733, name: 'FARINHA DE TRIGO PEQUENA INTEGRAL ANACONDA 1 KILO (FDO 10 KILO)', category: 'Farináceos', price: 70.90, image: 'https://i.imgur.com/MKJgzle.png' },
  ...
  { id: 1741, name: 'FARINHA DE TRIGO PEQUENA TIPO 1 GLOBO 1 KILO (FDO 10 KILO)', category: 'Farináceos', price: 33.50, image: 'https://i.imgur.com/cWAgrgi.png' },
  { id: 1742, name: 'FARINHA DE TRIGO PEQUENA TIPO 1 NITA 1 KILO (FDO 10 KILO)', category: 'Farináceos', price: 44.00, image: 'https://i.imgur.com/mrMEakl.png' },
  ...
  { id: 1756, name: 'FARINHA DE TRIGO PREMIUM ANACONDA 5 KILO (FDO 25 KILO)', category: 'Farináceos', price: 134.90, image: 'https://i.imgur.com/fe6V8D2.png' },
